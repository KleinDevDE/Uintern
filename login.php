...
if (isset($_POST['password'])){
    $errormessage = login($_POST['password']);
}
?>
<html>
<head>
...
<div id="content">
    <center><h2 id="h2small">Interner Bereich</h2></center>
    <form class="login-form" action="<?php echo htmlspecialchars("login.php");?>" method="post">
        <label>Passwort</label><br>
        <input type="password" value="Passwort" onclick="if (this.value === 'Passwort') this.value = '';
...
<div id="footer" class="blueBg">
    ...
    <a href="<?php echo getWebroot();?>/index.php?a=feedback" id="feedbackFooter">Feedback</a>
</div>
</body>
</html>